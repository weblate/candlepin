...
public class NodeProcessor {
    ...
    public RefreshResult processNodes() {
        ...
        for (Iterator<EntityNode> rootIterator = this.mapper.getRootIterator(); rootIterator.hasNext();) {
            this.processNodeImpl(visited, rootIterator.next());
        }
        ...
        visited = new HashSet<>();
        for (Iterator<EntityNode> leafIterator = this.mapper.getLeafIterator(); leafIterator.hasNext();) {
            this.pruneNodeImpl(visited, leafIterator.next());
        }
